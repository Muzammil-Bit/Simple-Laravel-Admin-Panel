...
<html>
	<head>
		<title>IPL Returns</title>
		<meta charset="utf-8" />
		<meta name="viewport" content="width=device-width, initial-scale=1, user-scalable=no" />
		<link rel="stylesheet" href="{{ asset('front-end/main.css') }}" />
		<noscript><link rel="stylesheet" href="{{ asset('front-end/noscript.css') }}" /></noscript>
	...
	<body class="is-preload">
		...
		<!-- Header -->
			<header id="header">
				<div class="content">
					...
					<p>IPL Returns @ 2021 Is a amazing app for <br> tracking IPL Live Scores</p>
					<ul class="actions">
				...
				<div class="image phone"><div class="inner"><img src="{{ asset('front-end/images/app-ss.jpg') }}" alt="" /></div></div>
			</header>

		<!-- One -->
			{{-- <section id="one" class="wrapper style2 special">
				<header class="major">
					<h2>Download now from g</h2>
				</header>
		...
		<!-- Scripts -->
			...
			<script src="{{ asset('front-end/js/jquery.scrolly.min.js') }}"></script>
			<script src="{{ asset('front-end/js/browser.min.js') }}"></script>
			<script src="{{ asset('front-end/js/breakpoints.min.js') }}"></script>
			<script src="{{ asset('front-end/js/util.js') }}"></script>
